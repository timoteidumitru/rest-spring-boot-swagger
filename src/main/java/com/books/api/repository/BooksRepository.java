...
public class BooksRepository {
    private final List<Book> dummyBookData = new ArrayList<>() {{
        add(new Book(1, "The Hobbit", "J.R.R. Tolkien's enchanting tale of adventure and heroism in Middle-earth, featuring the reluctant hero Bilbo Baggins.", "Adventure", 4.8));
        ...
        add(new Book(7, "The Da Vinci Code", "Dan Brown's gripping thriller featuring symbologist Robert Langdon on a quest to unravel ancient mysteries.", "Mystery", 4.3));
        add(new Book(8, "The Power of Habit: Why We Do What We Do in Life and Business", "Charles Duhigg's exploration of the science behind habits and how they can be transformed to achieve success.", "Nonfiction", 4.5));
